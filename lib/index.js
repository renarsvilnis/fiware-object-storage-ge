...
// Doesn't seem to return any, for now commented out
...
const putObject = function (securityToken, containerUrl, containerName, objectName, objectMimetype, objectContents, objectMetadata) {
...
module.exports = function (config) {
  ...
  return {
    ...
    putObject (objectName, objectMimetype, objectContents, objectMetadata, containerName) {
      ...
      return putObject(authData.token, authData.url, containerName, objectName, objectMimetype, objectContents, objectMetadata);
    },
